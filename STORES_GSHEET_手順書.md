...
STORES POS の期間別売上データ（今月・日別・全店舗+個別店舗）を毎日自動取得し、Google Spreadsheet に保存、売上サマリーを Slack に通知するシステム。GitHub Actions で毎日 09:50 JST に自動実行。
